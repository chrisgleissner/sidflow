...
- 2025‑11‑18 — Re-ran Playwright suite after Step 6/7 stabilization; confirmed all ML-powered stations plus Recently Played/Favorites behave under load (flaky specs isolated into single-worker track). Documentation updated to reference archive.
...
**Step 6: ML-Powered Features (COMPLETE)**

- [x] 6.1 — **Mood Transitions**: "Energetic → Ambient" cross-fading station
- [x] 6.2 — **Era Explorer**: "1980s SID Hits" or "Golden Age" time-travel playlists
- [x] 6.3 — **Composer Discovery**: "If you like Hubbard, try Hülsbeck" recommendations
- [x] 6.4 — **Hidden Gems Finder**: surface high-quality but under-played tracks
- [x] 6.5 — **Chip Model Stations**: "Pure 6581" or "8580 Showcase" for audiophiles
- [x] 6.6 — **Remix Radar**: find different versions/remixes of same tune
- [x] 6.7 — **Game Soundtrack Journeys**: "Great Giana Sisters OST" → similar game music
- [x] 6.8 — **Live ML Explanations**: "Why this track?" overlay showing feature similarity
- [x] 6.9 — **Collaborative Discovery**: "Users who liked X also loved Y"
- [x] 6.10 — **Adaptive Stations**: learn from skip/like actions and adjust playlist in real-time

**Step 7: Playback History & Favorites (COMPLETE)**

- [x] 7.1 — Add "Recently Played" section to Play tab (last 50 tracks)
- [x] 7.2 — Add "Favorites" collection (heart icon to save tracks)
- [x] 7.3 — Store favorites in preferences; sync with server
- [x] 7.4 — "Play Favorites Shuffle" button for quick access
- [x] 7.5 — Unit tests for favorites persistence
- [x] 7.6 — E2E test for adding/removing favorites
