            ...
            <div className="grid grid-cols-3 gap-2 text-center text-xs">
              <div>
                ...
                <p
                  ...
                  data-testid="classify-rendered-count"
                >
                  {rendered} / {total}
                </p>
              </div>
              <div>
                ...
                <p
                  className="font-semibold text-foreground"
                  data-testid="classify-essentia-count"
                >
                  {counters?.essentiaTagged ?? 0} / {total}
                </p>
              </div>
              <div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between text-[11px] uppercase tracking-wide">
                      ...
                      <span className={isStale ? 'text-yellow-500' : isWorking ? 'text-accent' : 'text-muted-foreground'}>{phaseText}</span>
                    </div>
                    <p
