...
// Set environment variable BEFORE importing storage module so it reads the test path
const TEST_PLAYLISTS_PATH = join(process.cwd(), 'test-workspace', 'playlists-storage-tests');
